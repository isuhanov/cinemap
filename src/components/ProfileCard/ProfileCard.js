        ...
        <div className="profile-container">
            <div className="profile-card">
                ...
                <header className="profile-card__header">
                    <ProfileAvatar otherClassName="profile-card__avatar"/>
                    <p className="profile-card__login title">login</p>
                ...
                <div className="profile-card__info">
                    ...
                    <div className="blue-fon-text">
                        <p className="profile-card__status">Какой-то очень интересный статус</p>
                    </div>
                </div>
